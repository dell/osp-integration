...
Manila uses a DriverBackedShare mechanism to manage share backends. You must create a Secret containing PowerStore credentials and then reference this secret in the Manila control-plane configuration.
